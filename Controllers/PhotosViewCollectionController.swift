...
class PhotosViewCollectionController: UICollectionViewController {


    
    var photoTitle: String = ""
        
    var photos: [FriendModel] = []
    
    override func viewDidLoad() {
        super.viewDidLoad()
        // Заголовок с FriendsController
        title = photoTitle
...
//        cell.photoImage.image = photos[indexPath.row].image
        cell.photoImage.image = photos[indexPath.row].photo
        return cell
    }
